...
class CountiesViewController: UIViewController
{
    ...
    override func viewDidLoad()
    {
        ...
        myCountyObject.append(CountyClass(Name: "Crawford", TaxRate: 6.25, Image: UIImage(named: "Crawford 2")!))
        myCountyObject.append(CountyClass(Name: "Cumberland", TaxRate: 6.25, Image: UIImage(named: "Cumberland 2")!))
        myCountyObject.append(CountyClass(Name: "DeKalb", TaxRate: 6.25, Image: UIImage(named: "DeKalb")!))
        myCountyObject.append(CountyClass(Name: "Dewitt", TaxRate: 6.25, Image: UIImage(named: "De_Witt")!))
        ...
        myCountyObject.append(CountyClass(Name: "Jo Daviess", TaxRate: 7.25, Image: UIImage(named: "Jo_Daviess")!))
        ...
        myCountyObject.append(CountyClass(Name: "La Salle", TaxRate: 6.5, Image: UIImage(named: "LaSalle")!))
        ...
        myCountyObject.append(CountyClass(Name: "Rock Island", TaxRate: 7.5, Image: UIImage(named: "Rock_Island")!))
        myCountyObject.append(CountyClass(Name: "St. Clair", TaxRate: 6.6, Image: UIImage(named: "St._Clair")!))
